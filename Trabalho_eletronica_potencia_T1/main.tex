...
\vspace{0.8em}
\textbf{Observa\c{c}\~ao:} os gr\'aficos deste trabalho foram gerados no GeoGebra, conforme solicitado no enunciado.
...
\textbf{Enunciado:} Considere o circuito de malha \'unica com diodo ideal e resistor de \(10\,\Omega\), alimentado por
\[
v_s(t)=311\sin(377t)\ \text{V}.
\]

\begin{figure}[H]
    \centering
    \includegraphics[width=0.34\linewidth]{grafico_Q1.png}
    \caption*{Circuito da Quest\~ao 1.}
\end{figure}
...
\textbf{Enunciado:} Considere o circuito com tiristor ideal e resistor de \(100\,\Omega\), alimentado por
\[
v_s(t)=179\sin(314t)\ \text{V},
\]
com disparos do tiristor em \(1{,}25\,\text{ms}\), \(11{,}25\,\text{ms}\) e \(21{,}25\,\text{ms}\).

\begin{figure}[H]
    \centering
    \includegraphics[width=0.34\linewidth]{grafico_Q2.png}
    \caption*{Circuito da Quest\~ao 2.}
\end{figure}
